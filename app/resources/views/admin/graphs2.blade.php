                                                                            ...
                                                                            <div class="dd-graphs">
                                                                                @foreach($intervalCodes as $key => $code)
                                                                                    <div class="dd-graphs__item">
                                                                                        <input type="text" name="interval" value="{{ $tool->data[\App\Enums\IntervalCodeEnum::from($key)->value]["interval"] ?? "" }}" class="form-control dd-graphs__item-interval">
                                                                                        ...
                                                                                        <input type="text" name="url" value="{{ $tool->data[\App\Enums\IntervalCodeEnum::from($key)->value]["url"] ?? "" }}" class="form-control dd-graphs__item-url" placeholder="Url">
                                                                                    </div>
                                                                                @endforeach
                                                                            </div>
                                                                        </li>
